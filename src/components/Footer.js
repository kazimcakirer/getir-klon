        ...
        <div className="bg-white py-4 sm:pt-10 sm:pb-6">
            <div className="container mx-auto grid gap-y-5">
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-y-4">
                    ...
                    <nav>
                        <Collapsible trigger="Getir'i keşfedin" className="text-lg text-purple-700 mb-4">
                ...
                <div className="flex justify-between flex-col items-center gap-y-3 sm:gap-y-0 sm:flex-row text-sm pt-1 sm:pt-3">
                    <div className="flex gap-x-4 text-gray-700 text-base">
                        &copy; 2021 Getir

                    </div>
                    <a href="/" className="text-purple-800 text-lg">Bilgi Toplumu Hizmetleri</a>
                    ...
                    <a href="/" className="transition-colors h-8 flex items-center gap-x-2 border !bg-gray-50 border-gray-100 rounded-lg text-sm text-gray-600 px-3 hover:bg-purple-50 hover:text-purple-700">
                        <FiGlobe size={18} />
                        Türkçe (TR)
                    </a>
                </div>
